...
int wxTreeListHeaderWindow::DoInsertItem(HWND hwndHeader, int iInsertAfter,int nWidth, LPSTR lpsz) 
{ 
    HDITEM hdi; 
    int index; 
...
#if defined(__WXMSW__)
    DoInsertItem(m_hndlHeader,before,colInfo.GetWidth(),(char *)colInfo.GetText().c_str());
#endif
